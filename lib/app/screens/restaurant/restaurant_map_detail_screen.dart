...
class RestaurantMapDetailScreen extends StatefulWidget {
  const RestaurantMapDetailScreen({
    super.key,
  ...
  @override
  State<RestaurantMapDetailScreen> createState() =>
      _RestaurantMapDetailScreenState();
}

class _RestaurantMapDetailScreenState extends State<RestaurantMapDetailScreen> {
                    ...
                    children: [
                      GoogleMap(
                        ...
                        initialCameraPosition: CameraPosition(
                          target: LatLng(
                            double.parse(widget.restaurant.latitude ?? '0.0'),
                            double.parse(widget.restaurant.longitude ?? '0.0'),
                          ),
                          zoom: 14.0,
                          bearing: 90.0,
                          tilt: 45.0,
