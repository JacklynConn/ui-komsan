...
class PlaceMapDetailScreen extends StatefulWidget {
  const PlaceMapDetailScreen({
    super.key,
  ...
  @override
  State<PlaceMapDetailScreen> createState() => _PlaceMapDetailScreenState();
}

class _PlaceMapDetailScreenState extends State<PlaceMapDetailScreen> {
                    ...
                    children: [
                      GoogleMap(
                        ...
                        initialCameraPosition: CameraPosition(
                          target: LatLng(
                            double.parse(widget.place.latitude ?? '0.0'),
                            double.parse(widget.place.longitude ?? '0.0'),
                          ),
                          zoom: 14.0,
                          bearing: 90.0,
                          tilt: 45.0,
